		...
		<div data-role="page" id="pageone" class="jqm-demos jqm-home">
					...
					<ul data-role="listview" data-inset="true">
						<li ng-repeat="os in ordensServico">
							<a href="#" ng-click="visualizar(os)">
								<img src="{{os.foto.caminhoCompletoThumb}}" class="ui-li-thumb">
			...
			<div ng-show="ordemServico != null && !verFoto">
			  ...
			  <div role="main" class="ui-content">
				<ul data-role="listview" data-inset="true">
					<li>
						<img src="{{ordemServico.foto.caminhoCompletoThumb}}" class="ui-li-thumb">
						...
						<li>
							<div class="row" ng-show="fotos.length > 0">
								...
								<a ng-repeat="foto in fotos" href="#" ng-click="setVerFoto(true, foto)" data-ajax="false">
									<img src="{{foto.caminhoCompletoThumb}}" class="ui-li-thumb col-lg-3" style="margin-top: 1%;">
								</a>
							</div>
							<div class="row" ng-show="fotos.length == 0">
								<div class="col-lg-4">
			...
			<div ng-show="ordemServico != null && verFoto">
			  ...
			  <div role="main" class="ui-content">
				<div class="article" style="text-align: center;">
					<p><img src="{{foto.caminhoCompleto}}" style="max-width: 100%; max-height: 100%;"></p>
					<p>
